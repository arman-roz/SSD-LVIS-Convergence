...
# split='val' tells LVISDataset to use TEST-mode transforms (no augmentation)
# LVIS has no 'difficult' flag so we don't need keep_difficult
...
def evaluate(val_loader, model):
    ...
    with torch.no_grad():
        ...
        # Calculate mAP across all 50 LVIS classes
